      ...
      <section className="max-w-6xl mx-auto px-6 py-24 md:py-32">
        <div className="grid md:grid-cols-12 gap-12 items-start mb-16">
          ...
          <div className="md:col-span-8 md:pt-4">
            ...
            <p className="text-base leading-relaxed" style={{ color: C.inkSoft }}>
              Схема-терапия — это «вторая волна» КПТ, разработанная Джеффри Янгом. Она исходит из того, что у каждого из нас в детстве формируются устойчивые представления о себе, других людях и мире — «схемы». Если базовые потребности ребёнка не были удовлетворены (например, в безопасности, принятии, автономии), схемы получаются болезненными. Во взрослой жизни они продолжают работать, и человек оказывается в одних и тех же ситуациях, реагирует одними и теми же способами, страдает по одним и тем же причинам.
            </p>
          </div>
        </div>
