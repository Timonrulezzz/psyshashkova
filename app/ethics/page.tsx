...
const quickPoints = [
  ...
  },
  {
    ...
    text:
      'Если в вашей ситуации нужен другой специалист или другой формат помощи, я скажу об этом прямо.',
  },
  {
    number: '03',
        ...
        <section className="mx-auto max-w-6xl px-6 pb-7 pt-10 md:px-8 md:pb-9 md:pt-14">
          <Reveal>
            <div className="w-full">
              ...
              >
                В психологической работе много личного, поэтому мне важно, чтобы правила не приходилось угадывать по ходу дела. Здесь я собрала то, что касается конфиденциальности, границ моей роли, связи между встречами и ситуаций, в которых нужен другой формат помощи.
              </p>
            </div>
          </Reveal>
        ...
        <section className="mx-auto max-w-6xl px-6 py-8 md:px-8 md:py-10">
          <Reveal>
            <div className="grid gap-y-3 md:grid-cols-2 md:gap-x-3">
              ...
              >
                <p>
                  Все, чем вы делитесь на встречах, я рассматриваю как конфиденциальную информацию. Я не пересказываю истории клиентов друзьям, близким или знакомым и не использую узнаваемые случаи в соцсетях, статьях или других публичных материалах.
                </p>
          ...
          <div className="mt-6 grid gap-3 md:grid-cols-2">
            ...
            <Reveal delay={35}>
              ...
              >
                Я еженедельно обсуждаю отдельные моменты своей работы с супервизором. Для разбора оставляю только то, что важно для случая, и убираю все, по чему вас можно узнать: имя, контакты, место работы и другие подобные детали.
              </InfoCard>
            </Reveal>
      ...
      <div className="p-6 md:p-8 lg:p-9">
        ...
        <section className="mx-auto max-w-6xl px-6 py-8 md:px-8 md:py-10">
          <Reveal>
            <div className="grid gap-y-3 md:grid-cols-[0.72fr_1.28fr] md:gap-x-10">
              ...
              >
                <p>
                  Самоповреждения, мысли о смерти или очень тяжелое состояние не всегда означают, что психологическая работа невозможна. Здесь важнее не сама тема, а то, насколько человек сейчас в безопасности.
                </p>

                <p>
                  Если непосредственной угрозы жизни нет, психологическая работа может быть возможна, иногда параллельно с наблюдением у психиатра. Но если человек планирует причинить себе вред, не уверен, что сможет оставаться в безопасности, или помощь требуется прямо сейчас, одной онлайн-встречи со мной уже недостаточно.
                </p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={60}>
            <div
              className="mt-6 grid gap-5 px-5 py-5 md:grid-cols-[0.72fr_1.28fr] md:gap-x-10 md:px-6"
              style={{
                backgroundColor:
                  'rgba(150, 59, 89, 0.07)',
                borderRadius: radius.md,
        ...
        <section className="mx-auto max-w-6xl px-6 py-8 md:px-8 md:py-10">
          ...
          <Reveal delay={80}>
            ...
            >
              Психологическая работа может быть очень личным разговором, но наши отношения остаются профессиональными. Мы не становимся друзьями и не продолжаем общение вне рамок работы. Так у вас остается пространство, где не нужно заботиться обо мне, поддерживать взаимность или думать, что я от вас чего-то жду.
            </p>
          </Reveal>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-6 py-7 md:px-8 md:py-9">
          <Reveal>
            ...
            >
              ...
              >
                <p>
                  Между встречами можно написать про время, перенос, ссылку, оплату или другую организационную деталь. Если хочется не потерять важную мысль или ситуацию до следующей встречи, можно коротко написать о ней.
                </p>

                <p>
                  Я могу отвечать не сразу, а полноценную работу мы не переносим в переписку. То, что требует разбора, оставляем на встречу.
                </p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={80}>
            ...
            >
              <InfoCard title="Если встречу нужно отменить или перенести">
                ...
                часов. Экстренные и непредвиденные ситуации разбираем отдельно.
              </InfoCard>
        ...
        <section className="mx-auto max-w-6xl px-6 pb-12 pt-5 md:px-8 md:pb-14">
          <Reveal>
            <div
              className="grid gap-6 px-6 py-7 md:grid-cols-[1fr_auto] md:items-end md:px-8 md:py-8"
              style={{
            ...
            >
              <div>
                ...
                <h2 className="mt-3 text-[28px] font-normal leading-[1.08] tracking-[-0.02em] md:text-[34px] md:mb-1">
                  Если условия вам подходят, оставьте заявку
                </h2>
              </div>
