  ...
  return (
    <section className="mx-auto max-w-6xl px-6 pb-12 pt-10 md:px-8 md:pt-14">
      <Reveal>
        ...
        <p
  className="mt-5 w-full text-[15px] leading-[1.7]"
  style={{ ...sans, color: C.inkSoft }}
>
  ...
  text="Ответы сохраняются в этом браузере на этом устройстве. К прохождению можно вернуться позже. Если устройством пользуется кто-то еще, сохраненные ответы могут быть доступны и ему."
/>
        </div>
      </Reveal>
...
function Result({
  ...
  <p
    className="mt-3 text-[13px] leading-[1.6] md:text-[14px]"
    style={{
      ...sans,
      color: '#C9C2B5',
    }}
  >
    На встрече свяжем результат с конкретными ситуациями из вашей жизни:
    посмотрим, когда эти темы особенно проявляются, как вы обычно
    реагируете и что помогает им повторяться.
  </p>
</div>
