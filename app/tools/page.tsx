...
const tools = [
  ...
  },
  {
    ...
    eyebrow: 'опросник · 20-25 минут',
    title: 'Опросник режимов схема-терапии',
    text: 'Полная версия SMI Дж. Янга в адаптации Касьяника и Романовой. 124 утверждения, 14 шкал — детские, копинговые, родительские и здоровые режимы. Показывает, какие внутренние состояния у вас сейчас активнее других.',
    color: C.terracotta,
    ready: true,
  },
  {
    ...
    text: 'Все 14 режимов из SMI и ещё 10 из расширенной классификации. Что это за состояния, как они ощущаются изнутри, что их запускает, какие схемы под ними лежат и что в ответ делает Здоровый Взрослый.',
    color: C.terracotta,
    ready: true,
  },
  {
    ...
    eyebrow: 'инструмент · постоянно',
    title: 'Карта схем и потребностей',
    text: 'Пять базовых потребностей и 18 ранних дезадаптивных схем. Какая потребность лежит за каждой схемой, как она проживается через капитуляцию, избегание и гиперкомпенсацию, что в ответ делает Здоровый Взрослый.',
    color: C.terracotta,
    ready: true,
  },
  {
