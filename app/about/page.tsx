              ...
              <div>
                ...
                >
                  ...
                  <p>
                    ...
                    психология как наука. Я постоянно изучаю
        ...
        <section className="mx-auto max-w-6xl px-6 py-8 md:px-8 md:py-10">
          ...
          <div className="mt-6 grid gap-3 md:grid-cols-2">
            ...
            <Reveal delay={60}>
              <InfoCard
  number="03"
  title="Необязательно быть серьезными весь час"
>
  Сложная тема не требует торжественного
  выражения лица. На встречах мы можем
  смеяться, шутить, вспоминать мемы,
  обсуждать сцены и персонажей из фильмов,
  сериалов или игр, иногда ругаться матом.
  Юмор вполне может соседствовать с
  разговором о чем-то важном.
</InfoCard>
            </Reveal>
    ...
    'Квалификация: клинический психолог',
            ...
            >
              <Reveal delay={index * 20}>
                <article
  className="flex h-auto min-h-[175px] flex-col px-4 py-4 sm:h-[190px] md:px-5"
                  style={{
                    backgroundColor:
                ...
                >
                  ...
                  <h3 className="mt-3 min-h-[40px] text-[14px] leading-[1.22] md:text-[14.5px]">
  {education.title}
</h3>

                  <p
  className="mt-1.5 min-h-[42px] text-[9.5px] leading-[1.42]"
                    style={{
                      ...sans,
                      color: C.inkSoft,
                    }}
                  ...
                  {education.result && (
  <p
    className="mt-auto pt-2 text-[9.5px] leading-[1.42]"
                      style={{
                        ...sans,
                        color: C.inkSoft,
                      }}
        ...
        <section className="mx-auto max-w-6xl px-6 py-8 md:px-8 md:py-10">
          <Reveal>
            <div className="grid gap-y-3 md:grid-cols-[0.72fr_1.28fr] md:gap-x-10">
              ...
              <p
  className="text-[14px] leading-[1.65] md:pt-[6px] md:text-[15px]"
  style={{
    ...sans,
    color: C.inkSoft,
  }}
>
  Пятьдесят минут с клиентом — только видимая часть работы.
  Между встречами я анализирую сложные случаи, разбираю работу
  на супервизии, изучаю новые данные и продолжаю развивать свои
  навыки — и как практик, и в исследовательской работе. Мне важно
  не останавливаться на нескольких знакомых техниках и не
  превращать их в универсальный ответ на все.
</p>
            </div>
          </Reveal>
...
>
  В психологии постоянно появляются новые данные,
  а часть привычных идей со временем пересматривается.
  Поэтому я изучаю исследования, обзоры и профессиональные
  рекомендации, разбираю методологию и ограничения,
  сопоставляю результаты разных работ и слежу за тем,
  как меняется научная база. Параллельно занимаюсь
  собственной исследовательской работой. Это помогает
  отличать убедительно звучащую идею от той, для которой есть достаточно оснований.
</CareCard>
            </Reveal>
          </div>
        </section>
