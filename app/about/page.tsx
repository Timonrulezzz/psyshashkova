    ...
    <div style={{ ...serif, backgroundColor: C.bg, color: C.ink }} className="min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="border-t border-b py-12 grid grid-cols-2 md:grid-cols-4 gap-8" style={{ borderColor: C.line }}>
          <div>
            <p className="text-4xl mb-2" style={{ color: C.terracotta }}>2,5 года</p>
            <p className="text-sm" style={{ ...sans, color: C.inkSoft }}>в практике</p>
          </div>
          <div>
            <p className="text-4xl mb-2" style={{ color: C.terracotta }}>250+</p>
            <p className="text-sm" style={{ ...sans, color: C.inkSoft }}>клиентов</p>
          </div>
          <div>
            <p className="text-4xl mb-2" style={{ color: C.terracotta }}>2 500+</p>
            <p className="text-sm" style={{ ...sans, color: C.inkSoft }}>часов работы</p>
          </div>
          <div>
            <p className="text-4xl mb-2" style={{ color: C.terracotta }}>5+ лет</p>
        ...
        <div className="grid md:grid-cols-12 gap-12">
          <div className="md:col-span-4">
            ...
            <p className="text-base leading-relaxed mb-6" style={{ color: C.inkSoft }}>
              Все документы подтверждены и проверяемы. Я перечисляю не «прошла курс», а конкретные программы с часами и квалификациями.
            </p>
            <p className="text-base leading-relaxed" style={{ color: C.inkSoft }}>
              В психологии много специалистов с двухмесячным курсом «коуч», и клиент имеет право знать, чему именно учился его терапевт.
            </p>
          </div>
          <div className="md:col-span-8">
            <div className="space-y-px">
              {education.map((e, i) => (
                <div key={i} className="p-6 transition hover:translate-x-1" style={{ backgroundColor: i % 2 === 0 ? C.surface : C.bg, borderLeft: `2px solid ${C.line}` }}>
      ...
      <section style={{ backgroundColor: C.ink, color: C.bg }}>
        <div className="max-w-6xl mx-auto px-6 py-24 md:py-32">
          <div className="max-w-2xl mb-16">
            ...
            <h2 className="text-3xl md:text-4xl leading-tight font-normal mb-6">
              Чего вы можете от меня ожидать. И чего точно не дождётесь
            </h2>
            <p className="text-base leading-relaxed" style={{ color: '#C9C2B5' }}>
              Это принципы, по которым я работаю.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-x-12 gap-y-10">
            {principles.map((p, i) => (
              <div key={i} className="border-t pt-6" style={{ borderColor: '#3a3530' }}>
      ...
      <section className="max-w-4xl mx-auto px-6 py-24 md:py-32">
        <div className="border-l-2 pl-8" style={{ borderColor: C.terracotta }}>
          ...
          <h2 className="text-2xl md:text-3xl leading-tight font-normal mb-6">
            Я делаю то же, что прошу делать клиентов
          </h2>
      ...
      <section style={{ backgroundColor: C.surface }}>
        <div className="max-w-6xl mx-auto px-6 py-24 md:py-32">
          <div className="grid md:grid-cols-12 gap-12 items-center">
            <div className="md:col-span-5">
              <div className="aspect-[3/4] rounded-sm flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #2a2a2a 0%, #4a4a4a 50%, #1a1a1a 100%)', color: '#888' }}>
      ...
      <section className="max-w-4xl mx-auto px-6 py-24">
        <div className="text-center">
          ...
          <p className="text-base leading-relaxed max-w-xl mx-auto mb-8" style={{ color: C.inkSoft }}>
            Мой личный канал. Заметки о психологии, наблюдения, иногда личное. Если хотите познакомиться со мной как с человеком — заходите.
          </p>
          <a href="https://t.me/wentintoabar" className="inline-block px-7 py-3 rounded-full text-sm border transition hover:opacity-80" style={{ ...sans, borderColor: C.ink, color: C.ink }}>
            t.me/wentintoabar →
          </a>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-24 md:pb-32">
        <div className="rounded-sm p-12 md:p-20 text-center" style={{ backgroundColor: C.ink, color: C.bg }}>
          <h2 className="text-3xl md:text-5xl leading-tight font-normal mb-8 max-w-3xl mx-auto">
            Решили, что хотите попробовать?
          </h2>
          <p className="text-lg leading-relaxed max-w-xl mx-auto mb-10" style={{ color: '#C9C2B5' }}>
            Первая сессия — диагностическая. По её итогам сами решите, продолжать ли работу со мной.
          </p>
